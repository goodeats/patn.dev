...
export async function handleVerification({
	...
	void sendEmail({
		...
		subject: 'Pat Needham email changed',
...
export function EmailChangeEmail({
	...
	return (
		<E.Html lang="en" dir="ltr">
			<E.Container>
				<h1>
					<E.Text>Pat Needham Email Change</E.Text>
				</h1>
				<p>
					<E.Text>
...
function EmailChangeNoticeEmail({ userId }: { userId: string }) {
	return (
		<E.Html lang="en" dir="ltr">
			<E.Container>
				<h1>
					<E.Text>Your Pat Needham email has been changed</E.Text>
				</h1>
				<p>
					<E.Text>
						We're writing to let you know that your Pat Needham email has been
						changed.
					</E.Text>
				</p>
				<p>
