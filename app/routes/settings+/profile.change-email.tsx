...
export async function action({ request }: ActionFunctionArgs) {
	...
	const response = await sendEmail({
		...
		subject: `patn.dev Email Change Verification`,
...
export function EmailChangeEmail({
	...
	return (
		<E.Html lang="en" dir="ltr">
			<E.Container>
				<h1>
					<E.Text>patn.dev Email Change</E.Text>
				</h1>
				<p>
					<E.Text>
...
export function EmailChangeNoticeEmail({ userId }: { userId: string }) {
	return (
		<E.Html lang="en" dir="ltr">
			<E.Container>
				<h1>
					<E.Text>Your patn.dev email has been changed</E.Text>
				</h1>
				<p>
					<E.Text>
						We're writing to let you know that your patn.dev email has been
						changed.
					</E.Text>
				</p>
				<p>
